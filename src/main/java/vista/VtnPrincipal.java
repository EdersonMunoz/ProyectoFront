...
public class VtnPrincipal extends javax.swing.JFrame {
  ...
  private VtnConsultarComida objVtnVerPrestamos;
  private vtnGestionaComidas objVtnGestionarLibro;
  ...
  public void asociarServicio(ComidaServices objComidaServices) {
  ...
  private void relacionarInternalFrameConJdesptokPane() {
    ...
    this.objVtnVerPrestamos = new VtnConsultarComida(this.objComidaServices);
    this.jDesktopPanelPrincipal.add(this.objVtnVerPrestamos);

    this.objVtnGestionarLibro = new vtnGestionaComidas(this.objComidaServices);
    this.jDesktopPanelPrincipal.add(this.objVtnGestionarLibro);
  }

  private void establecerIconoOrganizacion() {
    ImageIcon img1 = new javax.swing.ImageIcon(
      getClass().getResource("/recursos/logo.png")
    );
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jButtonGestionarComidas = new javax.swing.JButton();
        jButtonConsultarComida = new javax.swing.JButton();
        ...
        jLabelImagenOrganizacion.setText("imageLoad");

        jPanelMenu.setBackground(new java.awt.Color(153, 153, 255));

        jButtonGestionarComidas.setText("Gestionar comidas");
        jButtonGestionarComidas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonGestionarComidasActionPerformed(evt);
            }
        });

        jButtonConsultarComida.setText("Consultar comida");
        jButtonConsultarComida.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonConsultarComidaActionPerformed(evt);
            }
        });
        ...
        jPanelMenuLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelMenuLayout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(jButtonGestionarComidas)
                .addGap(47, 47, 47)
                .addComponent(jButtonConsultarComida)
  ...
  private void jButtonConsultarComidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConsultarComidaActionPerformed
  ...
  }//GEN-LAST:event_jButtonConsultarComidaActionPerformed

  private void jButtonVerEstadisticasActionPerformed(
    java.awt.event.ActionEvent evt
  ) {//GEN-FIRST:event_jButtonVerEstadisticasActionPerformed
  ...
  private void jButtonGestionarComidasActionPerformed(
    java.awt.event.ActionEvent evt
  ) {//GEN-FIRST:event_jButtonGestionarComidasActionPerformed
    this.objVtnGestionarLibro.setVisible(true);
    this.objVtnVerEstadisticas.setVisible(false);
    this.objVtnVerPrestamos.setVisible(false);
  }//GEN-LAST:event_jButtonGestionarComidasActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton jButtonConsultarComida;
    private javax.swing.JButton jButtonGestionarComidas;
